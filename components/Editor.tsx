...
export default function Editor({ initialData, paperId: initialPaperId, onSave }: EditorProps = {}) {
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      const examNameLower = (paperData.header.examName || '').toLowerCase();
      const isCycleTest = examNameLower.includes('cycle') || examNameLower.includes('cyclic') || examNameLower.includes('cylic');
